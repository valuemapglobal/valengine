  ...
  <div class="tags">
      ...
      <template v-for="(cardItem, cardIndex) in cardList">
        ...
        >
          <div class="top">
            ...
            <div class="icon" @click="openDrawer(cardItem.dataSources)">
              <!-- v-if="['tactics'].includes(cardItem.dataSources) || tactics.showIcon == '0'" -->
    ...
    >
      ...
      <div class="releaseContent">
        <span
          >当前策略未经过测试验证，可能导致诊断结果不符预期，是否发布？</span
        >
      </div>
      <div class="releaseBtnList">
        <el-button
          ...
          @click="release"
          >我已知晓，确认发布
          <span v-show="btnDisable">({{ countdown }})</span></el-button
        >
        <el-button type="primary" @click="openTestDrawer">立即测试 </el-button>
      </div>
    </el-dialog>
    <testDataDrawer
      ref="testDrawer"
  ...
  data() {
    return {
      ...
      tactics: {
        ...
        activeId: 1000, //当前策略列选择行的id
        switchStatus: '', //当前策略列选择行的switch状态
        btDisable: false, //规则组和规则switch是否启用
        showIcon: '1',
        loading: false,
        scroll: 0,
        visibleData: [{ name: '通用行业标签', descr: '标准策略', id: 1000 }], //虚拟滚动
      },
      ruleGroup: {
        dataList: [], //规则组数据
        ruleGroupData: {}, //规则组行数据
        activeId: 1100, //当前规则组选择行的id
        ...
        scroll: 0,
        visibleData: [
          { name: '标准对手方标签', descr: '标准规则组', id: 1100 },
        ], //虚拟滚动
      },
      rule: {
        dataList: [], //规则
        ...
        scroll: 0,
        visibleData: [
          { name: '客户', descr: '标准规则', id: 1101 },
          { name: '供应商', descr: '标准规则', id: 1102 },
          { name: '本方', descr: '标准规则', id: 1102 },
        ], //虚拟滚动
      },
        ...
        case 'tactics':
          ...
          if (data) {
            ...
            if (this.$refs.addTactics) {
              ...
              console.log(this.$refs.addTactics.modelForm)
            }
          }
          break
        case 'ruleGroup':
