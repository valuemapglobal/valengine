...
// 修改参数
export function updateInterfaceFieIdInfo(data) {
  return request({
    url: `${url}/interfaceManage/updateInterfaceFieIdInfo`,
    method: 'post',
    data,
  })
}
// 删除参数
export function removeInterfaceFieIdInfo(data) {
  return request({
    url: `${url}/interfaceManage/removeInterfaceFieIdInfo`,
    method: 'post',
    data,
  })
}
// 添加参数
export function saveInterfaceFieIdInfo(data) {
  return request({
    url: `${url}/interfaceManage/saveInterfaceFieIdInfo`,
    method: 'post',
    data,
  })
}
...
export function findInterfaceInfoTest(data) {
  return request({
    ...
    url: `${url}/interfaceRequest/apiPage`,
    method: 'post',
    data,
  })
}
