 ...
 */
@Data
public class UpdateInterfaceFieldIdInfoDTO implements Serializable {
    ...
    @Size(min = 1, max = 200, message = "interfaceFieldIdName应该在1-50字符之间")
    ...
    @Size(min = 1, max = 200, message = "interfaceFieldIdAlias应该在1-50字符之间")
    ...
    @Pattern(regexp = "^[01]$", message = "interfaceFieldIdRequired 只允许 0-入参，1-出参")
