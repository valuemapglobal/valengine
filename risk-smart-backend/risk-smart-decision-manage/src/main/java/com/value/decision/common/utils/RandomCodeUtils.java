...
public class RandomCodeUtils {
    private static final String Base32Alphabet = "23456789ABCDEFGHJKLMNPQRSTUVWXYZ";
    ...
    public static String generateNewCode(int flag, int flagBitLen) {
        return generateNewCode(6, flag, flagBitLen, 7);		//生成码6位，活动id 16位
    }
    ...
    public static String generateNewCode(int flag) {
        ...
        return generateNewCode(6, flag, 10, 7);		//生成码6位
    }

    public static String generateNewCode() {
        return generateNewCode(6, 0, 0, 7);					//生成码9位
    }
     ...
     * @return
     */
    public static Long getFlagFromCode(String code){
        long id = convertBase32CharToNum(code);
        return id >> (code.length()*5-10);
    }
