...
public class DataSourceAspect
{
    ...
    @Pointcut("@annotation(com.value.decision.framework.aspectj.lang.annotation.DataSource)"
            + "|| @within(com.value.decision.framework.aspectj.lang.annotation.DataSource)")
