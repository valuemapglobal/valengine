-- ============================================================
-- RiskSmart System 数据库初始化脚本
-- 数据库: risk_smart_system
-- 说明: RuoYi核心系统表 (用户、角色、菜单、部门等)
-- 表数量: 14
-- ============================================================
...
CREATE TABLE `sys_user` (
  ...
  `avatar` varchar(2555) DEFAULT '' COMMENT '头像地址',
...
CREATE TABLE `sys_dept` (
  ...
  `dept_name` varchar(150) DEFAULT '' COMMENT '部门名称',
...
CREATE TABLE `sys_role` (
  ...
  `data_scope` char(1) DEFAULT '5' COMMENT '数据范围（1：全部 2：自定 3：本部门 4：本部门及以下 5：个人）',
...
CREATE TABLE `sys_dict_data` (
  ...
  `dict_value` varchar(300) DEFAULT '' COMMENT '字典键值',
  `dict_type` varchar(100) DEFAULT '' COMMENT '字典类型',
...
CREATE TABLE `sys_oper_log` (
  ...
  `business_type` int(50) DEFAULT '0' COMMENT '业务类型（0其它 1新增 2修改 3删除）',
  ...
  `oper_ip` varchar(100) DEFAULT '' COMMENT '主机地址',
  ...
  `dept_id` int(11) DEFAULT NULL COMMENT '部门主键',
