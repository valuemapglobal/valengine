  ...
  <div style="position: relative">
    ...
    >
      ...
      >
        ...
        >
          <el-input v-model="form.interfaceFieldIdName"></el-input>
        </el-form-item>
        ...
        <el-form-item
          ...
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdAlias"></el-input>
        </el-form-item>
        <el-form-item
          :label="$t('interfacePlatform.parameterDescription')"
          prop="interfaceFieldIdDescription"
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdDescription"></el-input>
        </el-form-item>
        <el-row type="flex" justify="center" :gutter="20">
          <el-col :span="14">
            <el-form-item
              ...
              style="margin-top: 20px"
            >
              <el-select v-model="form.interfaceFieldIdType">
                <el-option
          ...
          >
            <el-radio-group
              v-model="form.interfaceFieldIdRequired"
              v-if="showRadio"
            >
              <el-radio :label="0">{{
        ...
        <el-form-item
          ...
          style="margin-top: 20px"
        >
          <el-select v-model="form.interfaceFieldIdDataType">
            <el-option
        ...
        <el-form-item
          ...
          prop="interfaceFieldIdIndex"
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdIndex"></el-input>
        </el-form-item>
        <el-form-item
          ...
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdRemark"></el-input>
        </el-form-item>
        <el-form-item
          :label="$t('interfacePlatform.defaultValue')"
          prop="interfaceFieldIdDefultValue"
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdDefultValue"></el-input>
        </el-form-item>
        <el-form-item
          ...
          style="margin-top: 20px"
        >
          <el-input v-model="form.interfaceFieldIdFather"></el-input>
        </el-form-item>
      </el-form>
...
import {
  saveInterfaceFieldIdInfo,
  updateInterfaceFieldIdInfo,
...
export default {
  ...
  methods: {
    getInfo(row) {
      ...
      this.form.fieIdNo = row.interfaceFieldIdManage
    ...
    confirm(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          // console.log('3333', this.showRadio, this.form.interfaceFieldIdRequired)
          // if (this.showRadio && !this.form.interfaceFieldIdRequired && this.form.interfaceFieldIdRequired !== 0) {
          //   this.showRadioMsg = true
          //   return
          // } else {
          //   this.showRadioMsg = false
          //   this.form.interfaceFieldIdRequired = 1 // 没有意义的参数 ，不传报错
          // }
          if (this.isEdit) {
            updateInterfaceFieldIdInfo({
              ...this.form,
