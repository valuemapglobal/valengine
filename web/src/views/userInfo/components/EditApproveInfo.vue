<template>
  <div style="height: 100%" class="enterprisecert-2">
    <!-- 头部信息 -->
    <InfoTitle title="企业信息">
      <template slot="right">
    ...
    <div class="formBox">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="170px">
        <el-form-item label="汇款账户名：" class="readonly">
          <el-input value="估图（上海）科技有限公司" />
        </el-form-item>
        <el-form-item label="汇款银行：" class="readonly">
          <el-input value="招商银行" />
        </el-form-item>
        <el-form-item label="汇款账户：" class="readonly">
          <el-input value="121931876810701" />
        </el-form-item>
        <el-form-item label="认证企业：" class="readonly">
          <el-input :value="bankInfo.enterpriseName" />
        </el-form-item>
        <el-form-item label="企业对公银行账号：" class="readonly">
          <el-input :value="bankInfo.bankAccount" />
        </el-form-item>
        <el-form-item label="开户支行：" class="readonly">
          <el-input :value="bankInfo.bankBranch" />
        </el-form-item>
        <el-form-item label="到账金额：" prop="money">
          <el-input v-model="form.money" placeholder="请填写">
