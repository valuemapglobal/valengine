            ...
            (secondLevel) => {
              ...
              if (
                ...
                secondLevelItem.children = secondLevel.fields.map(
                  (thirdLevel) => ({
                    label: thirdLevel.interfaceFieldIdDescription,
                    value: thirdLevel.interfaceFieldIdManage,
                    params: {
                      dataType: thirdLevel.interfaceFieldIdDataType,
                      fieldCode: thirdLevel.interfaceFieldIdName,
                      fieldName: thirdLevel.interfaceFieldIdAlias,
