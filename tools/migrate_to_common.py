...
# -*- coding: utf-8 -*-
"""
将 RuoYi 模块合并到 risk-smart-common 和 risk-smart-system
"""
...
def main():
    print("=" * 50)
    print("Merging modules to common and system")
    print("=" * 50)

    common_target = os.path.join(RISKSMART_PATH, "risk-smart-common")
    system_target = os.path.join(RISKSMART_PATH, "risk-smart-system")

    # 1. Redis -> common
    print("\n[1/4] Merging redis -> common...")
    count = copy_java_files(
        os.path.join(RUOYI_PATH, "ruoyi-common/ruoyi-common-redis"),
        common_target,
